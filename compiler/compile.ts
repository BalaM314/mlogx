...
function compileMlogxToMlog(data:string[]):string[] {
	...
	for(var line of data){
		if(line.startsWith("#") || line.startsWith("//")){
			...
			if(!line.match(/^increment [\S]+ [\d]+$/gi)) throw new Error(`Compiler error: \`increment\` used incorrectly\nat <${line}>\nExample of correct usage: increment variable_name 2`);
			...
			if(!line.match(/^throw .+$/gi)) throw new Error(`Compiler error: \`throw\` used incorrectly\nat <${line}>\nExample of correct usage: throw "Oh no!"`);

...
${formatLineWithPrefix(d.line)}`
	...
	"property not settable": {for:(d:{property:string}) => `Property ${d.property} is not settable.`, level:"throw"},
	...
	"invalid setprop shorthand": {for:(d:{token:string}) => `Invalid setprop statement, "${d.token}" must be of form "thing.property" or "thing[property]" and cannot contain special characters.`, level:"throw"},

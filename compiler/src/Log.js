...
${formatLineWithPrefix(d.line)}`,
    ...
    "invalid sensor": { for: (d) => `Sensor "${d.sensor}" is not valid on a target of type "${d.type}".\n${formatLineWithPrefix(d.line)}`, level: "warn" },
    ...
    "property not settable": { for: (d) => `Property ${d.property} is not settable.`, level: "throw" },
    ...
    "invalid sensor shorthand": { for: (d) => `Invalid sensor statement, "${d.token}" must be of form "thing.property" or "thing[property]" and cannot contain special characters.`, level: "throw" },
    "invalid setprop shorthand": { for: (d) => `Invalid setprop statement, "${d.token}" must be of form "thing.property" or "thing[property]" and cannot contain special characters.`, level: "throw" },

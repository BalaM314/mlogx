...
export const messages = extend()({
    ...
    "invalid uncompiled command definition": { for: (d) => `Tried to type check a line(\`${d.statement.cleanedSourceText}\` => \`${d.statement.text}\`) with invalid uncompiled command definition. This may cause issues with type checking. This is an error with MLOGX.`, level: "err" },

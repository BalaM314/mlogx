...
export const allShorthandCommands: [input:string, output:string][] = [
	...
	// [`setblock floor 10 32 @air`, `setblock floor @air 10 32 @derelict 0`],
	// [`setblock ore 10 32 @air`, `setblock ore @air 10 32 @derelict 0`],
	// [`setblock block 10 32 @air @derelict 1`, `setblock block @air 10 32 @derelict 0`], TODO implement
